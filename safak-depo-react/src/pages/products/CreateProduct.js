        ...
        <div className="max-w-md mx-auto bg-white p-6 rounded shadow relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="productCode" value={product.productCode} onChange={handleProductChange} className="w-full border rounded px-3 py-2" required />
                </div>
                <div>
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
                    <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-sm">
                        ...
                        <ul className="mb-4 text-gray-700">
                            ...
                            <li><b>Ürün Kodu:</b> {pendingProduct.productCode}</li>
